...
public class DBVocabulary {
	...
	public static final String KEY_QUESTIONTEXT = "QuestionText";// 题目
	...
	private static final String TAG = "DBVocabulary";
	// private static final String DATABASE_NAME = "cetp";// 数据库名
	private static final String DATABASE_TABLE = "Vocabulary_and_Structure";// 表名
	...
	public DBVocabulary(Context ctx) {
		this.context = ctx;
	...
	public long insertItem(String YYYYMM, String QuestionType,
			String QuestionNumber, String QuestionText, String SelectionA,
			String SelectionB, String SelectionC, String SelectionD,
	...
	public Cursor getAllItem() {
		return db.query(DATABASE_TABLE, new String[] { KEY_ID, KEY_YEARMONTH,
				KEY_QUESIONTYPE, KEY_QUESTIONNUMBER, KEY_QUESTIONTEXT,
				KEY_SELECTIONA, KEY_SELECTIONB, KEY_SELECTIONC, KEY_SELECTIOND,
				KEY_ANSWER, KEY_COMMENTS }, null, null, null, null, null);
	}
	...
	public Cursor getItem(long rowId) throws SQLException {
		Cursor mCursor = db.query(true, DATABASE_TABLE, new String[] { KEY_ID,
				...
				KEY_QUESTIONTEXT, KEY_SELECTIONA, KEY_SELECTIONB,
				KEY_SELECTIONC, KEY_SELECTIOND, KEY_ANSWER, KEY_COMMENTS },
