...
public class DBReadingOfQuestion {
	...
	private static final String TAG = "DBReadingOfQuestion";
	// private static final String DATABASE_NAME = "cetp";
	private static final String DATABASE_TABLE = "Reading_Comprehension_Question";
	...
	public DBReadingOfQuestion(Context ctx) {
		this.context = ctx;
	...
	public DBReadingOfQuestion open() throws SQLException {
	...
	public long insertItem(String YYYYMM, String QuestionType,
			String QuestionNumber,String Question,String SelectionA, String SelectionB,
		...
		initialValues.put(KEY_QUESTIONTEXT, Question);
	...
	public Cursor getAllItem() {
		return db.query(DATABASE_TABLE, new String[] { KEY_ID, KEY_YEARMONTH,
				KEY_QUESIONTYPE, KEY_QUESTIONNUMBER, KEY_QUESTIONTEXT, KEY_SELECTIONA,
	...
	public boolean updateItem(long rowId, String YYYYMM, String QuestionType,
		...
		args.put(KEY_QUESTIONTEXT, Question);
