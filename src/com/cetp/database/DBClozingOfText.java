...
public class DBClozingOfText {
	...
	private static final String TAG = "DBClozing";
	private static final String DATABASE_TABLE = "Clozing_Passage";
	...
	public DBClozingOfText(Context ctx) {
		this.context = ctx;
	...
	public long insertItem(String YYYYMM, String QuestionType,
			String PassageText, String QuestionStartNumber,
	...
	public Cursor getAllItem() {
		return db.query(DATABASE_TABLE, new String[] { KEY_ID, KEY_YEARMONTH,
				KEY_QUESIONTYPE, KEY_PASSAGETEXT, KEY_QUESTIONSTARTNUMBER,
				KEY_QUESTIONENDNUMBER, KEY_QUESTIONTOTAL }, null, null, null,
				null, null);
	}
	...
	public Cursor getItem(long rowId) throws SQLException {
		Cursor mCursor = db.query(true, DATABASE_TABLE, new String[] { KEY_ID,
				KEY_YEARMONTH, KEY_QUESIONTYPE, KEY_PASSAGETEXT,
				KEY_QUESTIONSTARTNUMBER, KEY_QUESTIONENDNUMBER,
				KEY_QUESTIONTOTAL }, KEY_ID + "=" + rowId, null, null, null,
				null, null);
	...
	public Cursor getItemFromYM(String YYYYMM) throws SQLException {
		Cursor mCursor = db.query(true, DATABASE_TABLE, new String[] { KEY_ID,
				KEY_YEARMONTH, KEY_QUESIONTYPE, KEY_PASSAGETEXT,
				KEY_QUESTIONSTARTNUMBER, KEY_QUESTIONENDNUMBER,
				KEY_QUESTIONTOTAL }, KEY_YEARMONTH + "=" + YYYYMM, null, null,
				null, null, null);
		if (mCursor != null) {
			mCursor.moveToFirst();
		}
